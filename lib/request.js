 ...
 * @param url A URL to send the request.
 * @param {Object} qs query string parameters to send.
 * @returns {Promise<any>} A promise with the response body.
 */
...
/**
 * Send a DELETE request to the authorization authority.
 * @param url A URL to send the request.
 * @returns {Promise<any>} A promise with the response body.
 */
